...
const content = {
    ...
    de: {
        ...
        info_lauchernalp_title: 'Lauchernalp',
        info_lauchernalp_text: 'Die Lauchernalp ist das schneesichere Skigebiet im Lötschental. Die Talstation der Luftseilbahn ist nur 10 Gehminuten von der Wohnung entfernt.',
        info_lauchernalp_webcam_link: 'Live-Webcams ansehen',
        info_lauchernalp_magicpass_text: 'Gut zu wissen: Der <a href="https://www.magicpass.ch" target="_blank">Magic Pass</a> ist auf der Lauchernalp gültig!',
        info_lauchernalp_activities_title: 'Das ganze Jahr ein Erlebnis',
        info_lauchernalp_activities_text_1: 'Das Lötschental bietet zu jeder Jahreszeit unvergessliche Erlebnisse.',
        info_lauchernalp_activities_text_2: '<strong>Frühling & Sommer:</strong> Entdecken Sie über 200 km markierte Wanderwege, die Sie durch blühende Alpwiesen, vorbei an klaren Bergseen und zu atemberaubenden Aussichtspunkten führen. Mountainbiker finden ebenfalls abwechslungsreiche Trails für jedes Niveau.',
        info_lauchernalp_activities_text_3: '<strong>Herbst:</strong> Wenn sich die Lärchenwälder golden färben, ist die ideale Zeit für Genusswanderungen und um die traditionellen "Tschäggättä"-Masken im Lötschentaler Museum zu entdecken.',
        info_lauchernalp_activities_text_4: '<strong>Winter:</strong> Die Lauchernalp verwandelt sich in ein Wintersportparadies mit perfekt präparierten Pisten, Freeride-Hängen, Winterwanderwegen und einer rasanten Schlittelbahn.',
    ...
    en: {
        ...
        info_lauchernalp_title: 'Lauchernalp',
        info_lauchernalp_text: 'The Lauchernalp is the snow-sure ski area in the Lötschental. The valley station of the cable car is only a 10-minute walk from the apartment.',
        info_lauchernalp_webcam_link: 'View live webcams',
        info_lauchernalp_magicpass_text: 'Good to know: The <a href="https://www.magicpass.ch" target="_blank">Magic Pass</a> is valid on the Lauchernalp!',
        info_lauchernalp_activities_title: 'An Experience All Year Round',
        info_lauchernalp_activities_text_1: 'The Lötschental offers unforgettable experiences in every season.',
        info_lauchernalp_activities_text_2: '<strong>Spring & Summer:</strong> Discover over 200 km of marked hiking trails that lead you through blooming alpine meadows, past clear mountain lakes, and to breathtaking viewpoints. Mountain bikers will also find varied trails for every level.',
        info_lauchernalp_activities_text_3: '<strong>Autumn:</strong> When the larch forests turn golden, it is the ideal time for leisurely hikes and to discover the traditional "Tschäggättä" masks in the Lötschental Museum.',
        info_lauchernalp_activities_text_4: '<strong>Winter:</strong> The Lauchernalp transforms into a winter sports paradise with perfectly groomed slopes, freeride areas, winter hiking trails, and a fast toboggan run.',
        live_title: 'Live Webcam chalet',
    ...
    fr: {
        ...
        info_lauchernalp_title: 'Lauchernalp',
        info_lauchernalp_text: 'La Lauchernalp est le domaine skiable à l\'enneigement garanti du Lötschental. La station inférieure du téléphérique n\'est qu\'à 10 minutes à pied de l\'appartement.',
        info_lauchernalp_webcam_link: 'Voir les webcams en direct',
        info_lauchernalp_magicpass_text: 'Bon à savoir : Le <a href="https://www.magicpass.ch" target="_blank">Magic Pass</a> est valable sur la Lauchernalp !',
        info_lauchernalp_activities_title: 'Une expérience toute l\'année',
        info_lauchernalp_activities_text_1: 'Le Lötschental offre des expériences inoubliables à chaque saison.',
        info_lauchernalp_activities_text_2: '<strong>Printemps & Été :</strong> Découvrez plus de 200 km de sentiers de randonnée balisés qui vous mènent à travers des prairies alpines en fleurs, le long de lacs de montagne limpides et vers des points de vue à couper le souffle. Les VTTistes trouveront également des pistes variées pour tous les niveaux.',
        info_lauchernalp_activities_text_3: '<strong>Automne :</strong> Lorsque les forêts de mélèzes se parent d\'or, c\'est le moment idéal pour des randonnées gourmandes et pour découvrir les masques traditionnels des "Tschäggättä" au musée du Lötschental.',
        info_lauchernalp_activities_text_4: '<strong>Hiver :</strong> La Lauchernalp se transforme en un paradis des sports d\'hiver avec des pistes parfaitement préparées, des pentes de freeride, des sentiers de randonnée hivernale et une piste de luge rapide.',
